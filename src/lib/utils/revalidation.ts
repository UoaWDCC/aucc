...
> = {
  ...
  galleryGlobal: {
    tag: 'galleryGlobal',
    relatedTags: getRevalidationTags('galleryGlobal'),
    revalidate: () => revalidateTag('galleryGlobal'),
  },
  tripReportsGlobal: {
    tag: 'tripReportsGlobal',
    relatedTags: getRevalidationTags('tripReportsGlobal'),
    revalidate: () => revalidateTag('tripReportsGlobal'),
  },
  riversGlobal: {
    tag: 'riversGlobal',
  ...
  resourcesGlobal: {
    tag: 'resourcesGlobal',
    relatedTags: getRevalidationTags('resourcesGlobal'),
    revalidate: () => revalidateTag('resourcesGlobal'),
  },
  gearHireGlobal: {
    tag: 'gearHireGlobal',
