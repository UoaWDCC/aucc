  ...
  return (
    <div className="flex w-full flex-col items-center px-4 md:items-end md:pt-12 md:pr-[14%] xl:pt-31">
      <div className="mt-11 mb-27.5 flex flex-row justify-center md:mb-2 xl:mr-6">
        <h1 className="font-heading text-grass text-center text-3xl tracking-tighter md:text-4xl xl:text-5xl">
          HEY THERE
        </h1>
      ...
      <p className="text-algae font-body mb-4 max-h-17 max-w-130 min-w-77 text-center text-[28px] leading-8 font-bold tracking-tighter italic md:mb-5 md:text-end md:text-lg xl:mr-2 xl:mb-9 xl:max-w-134 xl:text-[28px]">
        We’re the Auckland University Canoe Club.
      </p>

      <div className="font-body w-full max-w-130 text-center text-sm leading-5 italic md:max-w-95 md:text-end md:leading-5 lg:max-w-130 lg:text-sm">
