...
export function ContactUsSection() {
  return (
    <div className="before:bg-abyss before:clip-path-[polygon(0_0,100%_0,100%_85%,0_100%)] relative min-h-[1000px] w-full bg-[#121616] before:absolute before:inset-0 before:z-0">
