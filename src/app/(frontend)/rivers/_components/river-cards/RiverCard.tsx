...
export function RiverCard({ river }: RiverCardProps) {
  ...
  return (
    <div
      key={river.slug}
      className="bg-abyss text-cream relative flex flex-col-reverse justify-center rounded-2xl px-5 py-9 md:mx-10 md:flex-row md:gap-24 md:px-16 lg:mx-30"
    >
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-10 md:flex-row">
          ...
          <div className="flex md:w-[70%]">
            <div className="lg: flex min-w-[280px] flex-col md:min-w-[420px] lg:min-w-[480px]">
              <h2 className="font-heading mb-4 text-xl">{river.name}</h2>
