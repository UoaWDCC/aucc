  ...
  return (
    <div className="relative mx-auto mt-28 h-auto max-w-140">
      <div className="relative h-[850px] w-full">
        <div className="absolute right-[0%] bottom-[18%] z-10 aspect-[4/3] h-auto w-[25%] overflow-hidden rounded-[16px]">
          <Image
        ...
        <div className="absolute top-[10%] right-[0%] z-10 aspect-[5/8] h-auto w-[42%] overflow-hidden rounded-[16px]">
          <Image
        ...
        <div className="absolute top-[38%] left-[46%] z-20 aspect-[2/3] h-auto w-[24%] overflow-hidden rounded-[16px]">
          <Image
