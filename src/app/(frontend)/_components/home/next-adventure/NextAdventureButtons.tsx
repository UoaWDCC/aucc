...
export function NextAdventureButtons({ eventId }: NextAdventureButtonProps) {
  return (
    <div className="flex w-full items-start gap-3.5 text-xs md:text-[6px] lg:text-[10px]">
      {/* <button className="text-abyss bg-algae font-unbounded cursor-pointer rounded-3xl px-5 py-2 md:px-4 md:py-1.5 lg:px-6 lg:py-3">
        Sign Up
      </button> */}
