...
export async function GallerySection() {
  ...
  return (
    <div className="relative bg-linear-198 from-[#D4E2DA] from-30% to-[#FCF9EF]">
      ...
      <div>
        <div className="mx-auto hidden w-full max-w-[34%] items-end justify-between pt-48 pb-4 md:flex">
        ...
        <p className="font-body text-abyss mx-auto hidden max-w-[24.5%] -translate-x-[18%] pt-4 pb-48 italic md:block">
